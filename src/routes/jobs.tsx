    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
      ...
      <section className="mt-8 glass rounded-2xl p-5 sm:p-6 animate-fade-in">
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Field label={country === "Other country" ? "Country or city" : "City or area (optional)"}>
            <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground" />
            <input
              value={location}
              onChange={(e) => setLocation(e.target.value)}
               placeholder={country === "Other country" ? "e.g. Germany or Berlin" : country === "Nigeria" ? "Nigeria or Lagos" : `${country} or a city`}
