    ...
    <header className="sticky top-0 z-40 border-b border-border/40 backdrop-blur-xl bg-background/70">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          <span className="size-8 rounded-lg grid place-items-center bg-primary/20 text-primary ring-1 ring-primary/40 group-hover:bg-primary/30 transition">
        ...
        <Link
          to="/match"
          className="hidden sm:inline-flex items-center rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition"
        >
          Find your course
        </Link>
      </div>
